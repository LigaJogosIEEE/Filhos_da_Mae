...
function Player:configKey_left(button)
   left = button

end
function Player:configKey_right(button)
   right = button

end
function Player:configKey_up(button)
   up = button

end
function Player:configKey_down(button)
   down = button

end
function Player:configKey_jump(button)
   jump = button

end
function Player:configKey_atack(button)
   atack = button
...
function Player:keypressed(key, scancode, isrepeat)
    ...
    if key == jump and self.inGround then
...
function Player:keyreleased(key, scancode)
    ...
    if key == right then
        if 'right' == self.orientation then
